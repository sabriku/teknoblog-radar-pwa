...
const checks = [
  ...
  ['/api/intelligence?section=clusters', 200],
  ['/api/intelligence?section=lifecycle', 200],
  ['/api/intelligence?section=leadership', 200],
  ['/api/intelligence?section=watchlists', 200],
  ['/api/intelligence?section=pioneer-metrics', 200],
